...
const cartStyles = `
  ...
  .cart-item:hover {
    ...
    box-shadow: 0 8px 16px rgba(0, 126, 110, 0.1);
  }
        ...
        <div className="min-h-screen bg-white py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-2 mb-8">
              <Link
                to="/"
                className="flex items-center gap-2 text-[#007E6E] hover:text-[#005d52] transition-colors"
              >
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">
                Looks like you haven't added any items to your cart yet. Start shopping and find your favorite fruits!
              </p>
              <Link
                to="/shop"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="quantity-btn bg-gray-200 hover:bg-[#007E6E] text-gray-800 hover:text-white font-bold py-1 px-3 rounded-lg"
                        >
                          −
                        </button>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <p className="text-gray-600 text-sm">
                          Subtotal: <span className="font-bold text-[#007E6E]">
            ...
            <div className="lg:col-span-1">
              <div className="bg-linear-to-br from-[#007E6E] to-[#005d52] rounded-2xl p-8 text-white sticky top-24">
                ...
                <div className="flex justify-between mb-6 pb-6 border-b border-white/20">
                  <span>Tax (10%)</span>
                  <span className="font-semibold">
                    Rp {new Intl.NumberFormat('id-ID').format(getTotalPrice() * 0.1)}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center mb-8">
                  ...
                  <span className="text-3xl font-bold">
                    Rp {new Intl.NumberFormat('id-ID').format(getTotalPrice() * 1.1)}
                  </span>
                </div>

                {/* Checkout Button */}
                <button className="w-full bg-white text-[#007E6E] hover:bg-gray-100 font-bold py-4 px-6 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2">
                  <FaShoppingCart />
                  Proceed to Checkout
                </button>
